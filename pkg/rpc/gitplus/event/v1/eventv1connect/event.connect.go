...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/ImSingee/git-plus/pkg/rpc/gitplus/event/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	EventServiceName = "gitplus.event.v1.EventService"
)
...
const (
	...
	EventServiceSubscribeProcedure = "/gitplus.event.v1.EventService/Subscribe"
)

// EventServiceClient is a client for the gitplus.event.v1.EventService service.
...
// NewEventServiceClient constructs a client for the gitplus.event.v1.EventService service. By
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_gitplus_event_v1_event_proto.Services().ByName("EventService").Methods()
...
// Subscribe calls gitplus.event.v1.EventService.Subscribe.
...
// EventServiceHandler is an implementation of the gitplus.event.v1.EventService service.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gitplus.event.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) Subscribe(context.Context, *connect.Request[v1.SubscribeRequest], *connect.ServerStream[v1.SubscribeResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("gitplus.event.v1.EventService.Subscribe is not implemented"))
}
